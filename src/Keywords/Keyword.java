...
public class Keyword {
	 ...
	 * @param locatorValue: It is the Xpath or the Locator value should be listed
	 * @param textToEnter:  Which type the data should be enter in the string
	 *                      format.
	 */
	...
	public static void uploadPhoto(String locatorType, String locatorValue, String textToEnter) {
		getWebElement(locatorType, locatorValue).sendKeys(textToEnter);
	}
	 ...
	 * @param jcommand
	 */
	public static void usingJScriptsOperation(String jcommand, int no) {
		JavascriptExecutor js = (JavascriptExecutor) Constants.driver;
		js.executeAsyncScript(jcommand, 1);
